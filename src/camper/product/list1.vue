<template>
  <section class="plr-sm">
    <header class="y-center ptb-md sticky">
      <span class="size-md bolder">房车列表</span>
      <router-link to="/product/edit?classifyId=1">
    ...
    <my-table :showCheckbox="true" :data="productList" :config="tableConfig">
      <div slot="operating" slot-scope="product">
        ...
        <router-link class="mlr-xs" :to="'/product/edit?classifyId=1&productId=' + product.item.id">
